...
export function CardStackDemo() {
  return (
    <div className="ml-2 mt-20 flex items-center justify-center md:ml-0 md:mt-1">
...
const CARDS = [
  {
    ...
    content: (
      <p>
        These cards are amazing, <Highlight>I want to use them</Highlight> in my project. Framer
  ...
  },
  {
    ...
    content: (
      <p>
        I dont like this Twitter thing, <Highlight>deleting it right away</Highlight> because yolo.
        Instead, I would like to call it <Highlight>X.com</Highlight> so that it can easily be
  ...
  },
  {
    ...
    content: (
      <p>
        The first rule of
        <Highlight>Fight Club</Highlight> is that you do not talk about fight club. The second rule
        of
