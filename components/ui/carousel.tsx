    ...
    <div className="[perspective:1200px] [transform-style:preserve-3d] gap-10">
      ...
      >
        ...
        <div className='bg-[#C8974D] rounded w-110  text-white justify-center m-8 ml-7'>
            ...
            decoding="sync" />
                    <div className=''>
                        <div className='flex justify-between gap-25 ml-27'>
                            <span className='font-medium'>{title}</span>
                            <span>{donation} Donations</span>
                        </div>
                        <p className="mr-18">Donated: ${donated}m</p>
                        <p className='mt-4 ml-5'>Member of the GEM platform</p>
                    </div>
                </div>
        
                <div className='flex justify-between p-2'>
                    <span>~G.E.M~</span>
                    <span className='flex'><LocateIcon/> {location}</span>
                </div>
            </div>
      </li>
    </div>
