          ...
          <div className="container mx-auto flex max-w-6xl grid-cols-2 flex-col gap-6 py-8 pb-6 md:grid md:py-14 md:pb-8">
            <div className="flex flex-col gap-2">
              ...
              <p className="mt-2 font-medium md:mt-4">
                The InnerCity Mission GEMs [Giving Every Month] Initiative is a Monthly Giving
                Program for Partners who commit to make a regular financial donation to the
                InnerCity Mission for Children. It affords partners the opportunity to partner with
                The InnerCity Mission in a consistent and structured manner.
              </p>
